    ...
    <div class="container mx-auto px-6 max-w-md text-center">
      ...
      <div class="bg-white-50 p-6 rounded-lg shadow-md">
        <div class="mb-4">
          ...
          <p class="text-lg text-gray-700">오후 2시</p>
        </div>
        <div class="mb-4">
          <p class="text-sm text-gray-600">장소</p>
          <p class="font-medium text-gray-800">더채플앳청담 6층 채플홀</p>
          <p class="text-sm text-gray-500">서울 강남구 선릉로 757</p>
        </div>
